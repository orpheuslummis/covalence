    ...
    return (
        ...
        <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            ...
            <div className="col-span-full lg:col-span-1">
                <a className="flex-none text-2xl font-semibold text-white " href="#" aria-label="Brand">Covalence</a>
            </div>
            

            <div className="col-span-1">
                <h4 className="font-semibold text-gray-100">MVP</h4>

                <div className="mt-3 grid space-y-3">
                <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">How it Works</a></p>
            ...
            <div className="flex justify-between items-center">
                <p className="text-sm text-gray-400">© 2023 Covalence. All rights reserved.</p>
            </div>
