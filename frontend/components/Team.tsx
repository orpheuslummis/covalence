        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
            ...
            <p className="mt-3 text-gray-500">
              Swiss Army Knife of Strategy, who pivots business models with the
              finesse of a chess grandmaster.
            </p>
          ...
          <div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
            ...
            <p className="mt-3 text-gray-500">
              Jack-of-All-Trades Evangelist, fluent in the languages of code,
              sales, and investor schmoozing.
            </p>
