      ...
      <div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
          ...
          <form>
            <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
              ...
              <div className="sm:col-span-3">
                ...
                <div className="hs-tooltip inline-block">
                  <button
                    type="button"
                    className="hs-tooltip-toggle ml-1 tooltip tooltip-top"
                    data-tooltip="The name of your group you wanna create"
                  >
                    <svg
            ...
            <label
              htmlFor="af-account-full-name"
              className="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200 my-4"
            >
              Tean Members
            </label>
            ...
            <div className="mt-4">
              {showBtn && (
                <button
                  ...
                  className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
                >
                  Add Member
                </button>
              )}
